...
request('https://indodax.com/api/'+coin+'_btc/depth', function (error, response, body) {
  countDepth(response);
});
function countDepth(response){
  ...
  console.log("harga terendah jual : "+save['sell'][0][0]+" btc");
  console.log("harga tertinggi beli : "+save['buy'][0][0]+" btc");
